        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="w-full mt-1 p-3 rounded-xl bg-gray-800/80 border border-gray-700 placeholder-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
            {errors.fullName && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="Password"
                className="w-full mt-1 p-3 pr-10 rounded-xl bg-gray-800/80 border border-gray-700 placeholder-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <button
                type="button"
